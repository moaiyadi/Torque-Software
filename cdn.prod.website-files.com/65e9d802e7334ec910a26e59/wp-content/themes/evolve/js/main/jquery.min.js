! function(e, t) {
    ...
    k.fn = k.prototype = {
        ...
        isPlainObject: function(e) {
            return "object" === k.type(e) && !e.nodeType && !k.isWindow(e) && !(e.constructor && !h.call(e.constructor.prototype, "isPrototypeOf"))
        },
    ...
    var d = function(n) {
        ...
        var e, h, b, o, r, g, p, m, w, u, l, T, C, i, k, v, s, a, y, E = "sizzle" + +new Date,
            x = n.document,
            N = 0,
            c = 0,
            d = ie(),
        ...
        try {
            O.apply(L = F.call(x.childNodes), x.childNodes), L[x.childNodes.length].nodeType
        } catch (e) {
            O = {
        ...
        for (e in h = re.support = {}, r = re.isXML = function(e) {
                ...
                }, s = [], v = [], (h.qsa = K.test(C.querySelectorAll)) && (se(function(e) {
                ...
                }), v = v.length && new RegExp(v.join("|")), s = s.length && new RegExp(s.join("|")), e = K.test(i.compareDocumentPosition), y = e || K.test(i.contains) ? function(e, t) {
                ...
                if ((e.ownerDocument || e) !== C && T(e), t = t.replace(U, "='$1']"), h.matchesSelector && k && !D[t + " "] && (!s || !s.test(t)) && (!v || !v.test(t))) try {
                    var n = a.call(e, t);
        ...
        function me(d, h, g, m, v, e) {
            return m && !m[E] && (m = me(m)), v && !v[E] && (v = me(v, e)), oe(function(e, t, n, r) {
                var i, o, s, a = [],
                    u = [],
                    l = t.length,
                    c = e || function(e, t, n) {
                ...
                } else p = ge(p === t ? p.splice(l, p.length) : p), v ? v(null, t, p, r) : O.apply(t, p)
            })
        }
        ...
        function ve(m, v) {
            function e(e, t, n, r, i) {
                ...
                if (u += l, y && l !== u) {
                    ...
                    O.apply(r, f), i && !e && 0 < f.length && 1 < u + v.length && re.uniqueSort(r)
                }
                return i && (N = h, w = p), c
            }
            var y = 0 < v.length,
    ...
    k.fn.extend({
        ...
        k.fn[r] = function(e, t) {
            ...
            return "Until" !== r.slice(-5) && (t = e), t && "string" == typeof t && (n = k.filter(t, n)), 1 < this.length && (j[r] || k.uniqueSort(n), D.test(r) && n.reverse()), this.pushStack(n)
        }
    });
    var L, q = /\S+/g;
    ...
    k.Callbacks = function(r) {
        ...
        ready: function(e) {
            (!0 === e ? --k.readyWait : k.isReady) || ((k.isReady = !0) !== e && 0 < --k.readyWait || (L.resolveWith(C, [k]), k.fn.triggerHandler && (k(C).triggerHandler("ready"), k(C).off("ready"))))
        }
    }), k.ready.promise = function(e) {
        return L || (L = k.Deferred(), "complete" === C.readyState || "loading" !== C.readyState && !C.documentElement.doScroll ? T.setTimeout(k.ready) : (C.addEventListener("DOMContentLoaded", H), T.addEventListener("load", H))), L.promise(e)
    }, k.ready.promise();
        ...
        remove: function(e, t) {
            ...
            if (void 0 !== o) {
                if (void 0 === t) this.register(e);
                    ...
                    n = (r = k.isArray(t) ? t.concat(t.map(k.camelCase)) : (i = k.camelCase(t), t in o ? [t, i] : (r = i) in o ? [r] : r.match(q) || [])).length;
                    for (; n--;) delete o[r[n]]
                }
    ...
    function $(e, t, n) {
        ...
        if (void 0 === n && 1 === e.nodeType)
            if (r = "data-" + t.replace(I, "-$&").toLowerCase(), "string" == typeof(n = e.getAttribute(r))) {
                try {
                    n = "true" === n || "false" !== n && ("null" === n ? null : +n + "" === n ? +n : W.test(n) ? k.parseJSON(n) : n)
                } catch (e) {}
                M.set(e, t, n)
            } else n = void 0;
        return n
    ...
    k.extend({
        ...
        data: function(r, e) {
            ...
            if (void 0 !== r) return "object" == typeof r ? this.each(function() {
                ...
                var e, n;
                return o && void 0 === t ? void 0 !== (e = M.get(o, r) || M.get(o, r.replace(I, "-$&").toLowerCase())) ? e : (n = k.camelCase(r), void 0 !== (e = M.get(o, n)) ? e : void 0 !== (e = $(o, n, void 0)) ? e : void 0) : (n = k.camelCase(r), void this.each(function() {
                    var e = M.get(this, n);
        ...
        add: function(t, e, n, r, i) {
            ...
            if (h)
                for (n.handler && (n = (o = n).handler, i = o.selector), n.guid || (n.guid = k.guid++), (a = h.events) || (a = h.events = {}), (s = h.handle) || (s = h.handle = function(e) {
                    ...
                    }), u = (e = (e || "").match(q) || [""]).length; u--;) f = d = (l = ne.exec(e[u]) || [])[1], p = (l[2] || "").split(".").sort(), f && (c = k.event.special[f] || {}, f = (i ? c.delegateType : c.bindType) || f, c = k.event.special[f] || {}, l = k.extend({
                    type: f,
                    origType: d,
                    data: r,
                    handler: n,
                    ...
                    namespace: p.join(".")
                }, o), (d = a[f]) || ((d = a[f] = []).delegateCount = 0, c.setup && !1 !== c.setup.call(t, r, p, s) || t.addEventListener && ("submit" == f ? t.addEventListener(f, s) : t.addEventListener(f, s, {
                    passive: !0
                }))), c.add && (c.add.call(t, l), l.handler.guid || (l.handler.guid = n.guid)), i ? d.splice(d.delegateCount++, 0, l) : d.push(l), k.event.global[f] = !0)
        },
    ...
    function me(n, r, i, o) {
        ...
        if (h || 1 < f && "string" == typeof d && !m.checkClone && le.test(d)) return n.each(function(e) {
            var t = n.eq(e);
            h && (r[0] = d.call(this, e, t.html())), me(t, r, i, o)
        });
    ...
    var Ce, ke, Ee, Ne, Se, De, je = /^margin/,
    ...
    function He() {
        De.style.cssText = "-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box;position:relative;display:block;margin:auto;border:1px;padding:1px;top:1%;width:50%", De.innerHTML = "", qe.appendChild(Se);
        var e = T.getComputedStyle(De);
        Ce = "1%" !== e.top, Ne = "2px" === e.marginLeft, ke = "4px" === e.width, De.style.marginRight = "50%", Ee = "4px" === e.marginRight, qe.removeChild(Se)
    }

    function Oe(e, t, n) {
        var r, i, o = e.style;
        return (n = n || Le(e)) && ("" !== (i = n.getPropertyValue(t) || n[t]) || k.contains(e.ownerDocument, e) || (i = k.style(e, t)), !m.pixelMarginRight() && Ae.test(i) && je.test(t) && (r = o.width, e = o.minWidth, t = o.maxWidth, o.minWidth = o.maxWidth = o.width = i, i = n.width, o.width = r, o.minWidth = e, o.maxWidth = t)), void 0 !== i ? i + "" : i
    }
    ...
    Se = C.createElement("div"), (De = C.createElement("div")).style && (De.style.backgroundClip = "content-box", De.cloneNode(!0).style.backgroundClip = "", m.clearCloneStyle = "content-box" === De.style.backgroundClip, Se.style.cssText = "border:0;width:8px;height:0;top:0;left:-9999px;padding:0;margin-top:1px;position:absolute", Se.appendChild(De), k.extend(m, {
        ...
        reliableMarginRight: function() {
            var e, t = De.appendChild(C.createElement("div"));
            return t.style.cssText = De.style.cssText = "-webkit-box-sizing:content-box;box-sizing:content-box;display:block;margin:0;border:0;padding:0", t.style.marginRight = t.style.width = "0", De.style.width = "1px", qe.appendChild(Se), e = !parseFloat(T.getComputedStyle(t).marginRight), qe.removeChild(Se), De.removeChild(t), e
        }
    }));
    var Pe = /^(none|table(?!-c[ea]).+)/,
        ...
        We = ["Webkit", "O", "Moz", "ms"],
        Ie = C.createElement("div").style;

    function $e(e) {
        if (e in Ie) return e;
        for (var t = e[0].toUpperCase() + e.slice(1), n = We.length; n--;)
            if ((e = We[n] + t) in Ie) return e
    }
    ...
    function Xe(e, t, n) {
        ...
        if (C.msFullscreenElement && T.top !== T && e.getClientRects().length && (i = Math.round(100 * e.getBoundingClientRect()[t])), i <= 0 || null == i) {
    ...
    k.extend({
        ...
        style: function(e, t, n, r) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var i, o, s, a = k.camelCase(t),
                    u = e.style;
                return t = k.cssProps[a] || (k.cssProps[a] = $e(a) || a), s = k.cssHooks[t] || k.cssHooks[a], void 0 === n ? s && "get" in s && void 0 !== (i = s.get(e, !1, r)) ? i : u[t] : ("string" === (o = typeof n) && (i = _.exec(n)) && i[1] && (n = z(e, t, i), o = "number"), void(null != n && n == n && ("number" === o && (n += i && i[3] || (k.cssNumber[a] ? "" : "px")), m.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (u[t] = "inherit"), s && "set" in s && void 0 === (n = s.set(e, n, r)) || (u[t] = n))))
            }
        },
    ...
    }), k.cssHooks.marginRight = Fe(m.reliableMarginRight, function(e, t) {
        return t ? Te(e, {
        ...
        }, je.test(i) || (k.cssHooks[i + o].set = Be)
    }), k.fn.extend({
        css: function(e, t) {
            return F(this, function(e, t, n) {
                var r, i, o = {},
                    s = 0;
                if (k.isArray(t)) {
                    for (r = Le(e), i = t.length; s < i; s++) o[t[s]] = k.css(e, t[s], !1, r);
                    return o
                }
    ...
    k.Animation = k.extend(et, {
        ...
        tweener: function(e, t) {
            for (var n, r = 0, i = (e = k.isFunction(e) ? (t = e, ["*"]) : e.match(q)).length; r < i; r++) n = e[r], et.tweeners[n] = et.tweeners[n] || [], et.tweeners[n].unshift(t)
        },
    ...
    }, d = C.createElement("input"), n = C.createElement("select"), s = n.appendChild(C.createElement("option")), d.type = "checkbox", m.checkOn = "" !== d.value, m.optSelected = s.selected, n.disabled = !0, m.optDisabled = !s.disabled, (d = C.createElement("input")).value = "t", d.type = "radio", m.radioValue = "t" === d.value;
    ...
    k.fn.extend({
        ...
        toggleClass: function(i, t) {
            ...
            return "boolean" == typeof t && "string" == o ? t ? this.addClass(i) : this.removeClass(i) : k.isFunction(i) ? this.each(function(e) {
                ...
                var e, t, n, r;
                if ("string" == o)
                    for (t = 0, n = k(this), r = i.match(q) || []; e = r[t++];) n.hasClass(e) ? n.removeClass(e) : n.addClass(e);
            ...
            select: {
                get: function(e) {
                    for (var t, n = e.options, r = e.selectedIndex, i = "select-one" === e.type || r < 0, o = i ? null : [], s = i ? r + 1 : n.length, a = r < 0 ? s : i ? r : 0; a < s; a++)
                        if (((t = n[a]).selected || a === r) && (m.optDisabled ? !t.disabled : null === t.getAttribute("disabled")) && (!t.parentNode.disabled || !k.nodeName(t.parentNode, "optgroup"))) {
    ...
    k.extend(k.event, {
        trigger: function(e, t, n, r) {
            var i, o, s, a, u, l, c = [n || C],
                ...
                d = o = n = n || C;
            if (3 !== n.nodeType && 8 !== n.nodeType && !ut.test(f + k.event.triggered) && (-1 < f.indexOf(".") && (f = (p = f.split(".")).shift(), p.sort()), a = f.indexOf(":") < 0 && "on" + f, (e = e[k.expando] ? e : new k.Event(f, "object" == typeof e && e)).isTrigger = r ? 2 : 3, e.namespace = p.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = n), t = null == t ? [e] : k.makeArray(t, [e]), l = k.event.special[f] || {}, r || !l.trigger || !1 !== l.trigger.apply(n, t))) {
                if (!r && !l.noBubble && !k.isWindow(n)) {
                    for (s = l.delegateType || f, ut.test(s + f) || (d = d.parentNode); d; d = d.parentNode) c.push(d), o = d;
    ...
    bt.href = lt.href, k.extend({
        ...
        ajax: function(e, t) {
            ...
            var u, l, c, n, f, r, p, i, d = k.ajaxSetup({}, t),
                ...
                b = {
                    ...
                    getResponseHeader: function(e) {
                        ...
                        if (2 === x) {
                            if (!n)
                                for (n = {}; t = ht.exec(c);) n[t[1].toLowerCase()] = t[2];
                            t = n[e.toLowerCase()]
                        }
            ...
            if (m.promise(b).complete = v.add, b.success = b.done, b.error = b.fail, d.url = ((e || d.url || lt.href) + "").replace(pt, "").replace(mt, lt.protocol + "//"), d.type = t.method || t.type || d.method || d.type, d.dataTypes = k.trim(d.dataType || "*").toLowerCase().match(q) || [""], null == d.crossDomain) {
                r = C.createElement("a");
                try {
                    r.href = d.url, r.href = r.href, d.crossDomain = bt.protocol + "//" + bt.host != r.protocol + "//" + r.host
                } catch (e) {
                    d.crossDomain = !0
                }
            }
            if (d.data && d.processData && "string" != typeof d.data && (d.data = k.param(d.data, d.traditional)), Tt(vt, d, t, b), 2 === x) return b;
            for (i in (p = k.event && d.global) && 0 == k.active++ && k.event.trigger("ajaxStart"), d.type = d.type.toUpperCase(), d.hasContent = !gt.test(d.type), l = d.url, d.hasContent || (d.data && (l = d.url += (ft.test(l) ? "&" : "?") + d.data, delete d.data), !1 === d.cache && (d.url = dt.test(l) ? l.replace(dt, "$1_=" + ct++) : l + (ft.test(l) ? "&" : "?") + "_=" + ct++)), d.ifModified && (k.lastModified[l] && b.setRequestHeader("If-Modified-Since", k.lastModified[l]), k.etag[l] && b.setRequestHeader("If-None-Match", k.etag[l])), (d.data && d.hasContent && !1 !== d.contentType || t.contentType) && b.setRequestHeader("Content-Type", d.contentType), b.setRequestHeader("Accept", d.dataTypes[0] && d.accepts[d.dataTypes[0]] ? d.accepts[d.dataTypes[0]] + ("*" !== d.dataTypes[0] ? ", " + xt + "; q=0.01" : "") : d.accepts["*"]), d.headers) b.setRequestHeader(i, d.headers[i]);
            ...
            function w(e, t, n, r) {
                ...
                }(d, s, b, r), r ? (d.ifModified && ((n = b.getResponseHeader("Last-Modified")) && (k.lastModified[l] = n), (n = b.getResponseHeader("etag")) && (k.etag[l] = n)), 204 === e || "HEAD" === d.type ? a = "nocontent" : 304 === e ? a = "notmodified" : (a = s.state, i = s.data, r = !(o = s.error))) : (o = a, !e && a || (a = "error", e < 0 && (e = 0))), b.status = e, b.statusText = (t || a) + "", r ? m.resolveWith(h, [i, a, b]) : m.rejectWith(h, [b, a, o]), b.statusCode(y), y = void 0, p && g.trigger(r ? "ajaxSuccess" : "ajaxError", [b, d, r ? i : o]), v.fireWith(h, [b, a]), p && (g.trigger("ajaxComplete", [b, d]), --k.active || k.event.trigger("ajaxStop")))
            }
            return b
        },
    ...
    k.param = function(e, t) {
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var e = this.type;
                return this.name && !k(this).is(":disabled") && Dt.test(this.nodeName) && !St.test(e) && (this.checked || !U.test(e))
            }).map(function(e, t) {
                var n = k(this).val();
    ...
    m.cors = !!At && "withCredentials" in At, m.ajax = At = !!At, k.ajaxTransport(function(i) {
        var o, s;
        return m.cors || At && !i.crossDomain ? {
            send: function(e, t) {
                var n, r = i.xhr();
    ...
    k.ajaxSetup({
        ...
        return s || "jsonp" === e.dataTypes[0] ? (r = e.jsonpCallback = k.isFunction(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, s ? e[s] = e[s].replace(qt, "$1" + r) : !1 !== e.jsonp && (e.url += (ft.test(e.url) ? "&" : "?") + e.jsonp + "=" + r), e.converters["script json"] = function() {
    ...
    }), m.createHTMLDocument = ((d = C.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>", 2 === d.childNodes.length), k.parseHTML = function(e, t, n) {
        if (!e || "string" != typeof e) return null;
        "boolean" == typeof t && (n = t, t = !1), t = t || (m.createHTMLDocument ? C.implementation.createHTMLDocument("") : C);
        var r = b.exec(e),
            n = !n && [];
    ...
    k.fn.load = function(e, t, n) {
        ...
        offset: function(t) {
            ...
            var e, n = this[0],
                ...
                i = n && n.ownerDocument;
            return i ? (e = i.documentElement, k.contains(e, n) ? (r = n.getBoundingClientRect(), i = Ot(i), {
        ...
        position: function() {
            if (this[0]) {
                ...
                return "fixed" === k.css(n, "position") ? t = n.getBoundingClientRect() : (e = this.offsetParent(), t = this.offset(), k.nodeName(e[0], "html") || (r = e.offset()), r.top += k.css(e[0], "borderTopWidth", !0) - e.scrollTop(), r.left += k.css(e[0], "borderLeftWidth", !0) - e.scrollLeft()), {
    ...
    return k.noConflict = function(e) {
        return T.$ === k && (T.$ = Pt), e && T.jQuery === k && (T.jQuery = Ft), k
    }, e || (T.jQuery = T.$ = k), k
});